...
const occupiers: Record<string, { name: string; domain?: string }[]> = {
  A: [
    { name: 'Advocacy Support Cymru', domain: 'ascymru.org.uk' },
    { name: 'ADT House', domain: 'adt.co.uk' },
    { name: 'Asbri Planning', domain: 'asbriplanning.co.uk' },
    { name: 'Ash Tree Clinic', domain: 'ashtreeclinic.co.uk' },
    { name: 'Atlantic Property Developments', domain: 'atlantic.wales' },
    { name: 'Azets Holdings', domain: 'azets.co.uk' },
  ],
  B: [
    { name: 'Bartholomew Financial Limited' },
    { name: 'Bartholomew Hawkins Ltd', domain: 'bhifa.co.uk' },
    { name: 'Biotal', domain: 'biotal.co.uk' },
    { name: 'Boyer Planning', domain: 'boyerplanning.co.uk' },
    { name: 'BPU Chartered Accountants', domain: 'bpuaccountants.co.uk' },
    { name: 'Briscombe Care' },
    { name: 'BT Local Business', domain: 'bt.com' },
    { name: 'Bullock', domain: 'bullock.co.uk' },
    { name: 'Busy Bees', domain: 'busybees.com' },
  ],
  C: [
    { name: 'Carbon60 Limited', domain: 'carbon60.com' },
    { name: 'Cardiff Audi', domain: 'monmotors.com' },
    { name: 'Castleoak Care Partnership' },
    { name: 'Chessmann', domain: 'chessmann.co.uk' },
    { name: 'chin-wag.com' },
    { name: 'Circle IT Solutions Ltd', domain: 'circleit.co.uk' },
    { name: 'Coca Cola', domain: 'coca-cola.com' },
    { name: 'Coors', domain: 'coors.com' },
    { name: 'CPS Group', domain: 'cpsgroup.co.uk' },
  ],
  E: [
    { name: 'Eco2', domain: 'eco2uk.com' },
    { name: 'eMag Europe' },
  ],
  F: [
  ...
  L: [
    ...
    { name: 'Linaker Green Ltd', domain: 'linakergreen.com' },
    { name: 'Lloyds Banking Group', domain: 'lloydsbankinggroup.com' },
  ],
  M: [
    { name: 'Marketing Tom Media', domain: 'marketingtommedia.co.uk' },
    ...
    { name: 'MPCT', domain: 'mpct.co.uk' },
    { name: 'Mudiad Ysgolian Meithrin', domain: 'meithrin.cymru' },
  ],
  N: [
    { name: 'NASUWT Cymru', domain: 'nasuwt.org.uk' },
  ],
  P: [
    { name: 'PMG Group', domain: 'pmg-plc.com' },
    { name: 'PMH UK Ltd' },
  ],
  Q: [
    { name: 'QTS Ltd.' },
  ...
  R: [
    ...
    { name: 'Rhomco Consulting', domain: 'rhomco.co.uk' },
    { name: 'Royal Pharmaceutical Society of Great Britain', domain: 'rpharms.com' },
  ],
  S: [
    { name: 'SBW Wales', domain: 'sbwadvertising.co.uk' },
    { name: 'Scottish & Southern Energy', domain: 'sse.com' },
    { name: 'Secure Law', domain: 'securelaw.co.uk' },
    { name: 'Shear Design Ltd.', domain: 'shear-design.com' },
    { name: 'Shell', domain: 'shell.com' },
    { name: 'Smiles Dental', domain: 'smilesdental.co.uk' },
    { name: 'SMS Plc', domain: 'sms-plc.com' },
    { name: 'Sofa Brands International', domain: 'sofabrands.com' },
    { name: 'Spie Matthew Hall', domain: 'spieuk.com' },
    { name: 'Sports Xtra', domain: 'sports-xtra.com' },
    { name: 'St. James Parade' },
    { name: 'SWALEC & Atlantic Electric and Gas' },
  ],
  T: [
    { name: 'The Independent General Practice', domain: 'theigp.co.uk' },
  ...
  U: [
    { name: 'UME Diagnostics', domain: 'umegroup.co.uk' },
  ...
  W: [
    ...
    { name: 'Watts Gregory Chartered Accountants', domain: 'watts-gregory.co.uk' },
    { name: 'Welcome Break Services', domain: 'welcomebreak.co.uk' },
    { name: 'Welsh Power Group', domain: 'welshpower.com' },
    { name: 'Westcoast Labs', domain: 'westcoastlabs.com' },
